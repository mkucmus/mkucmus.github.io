...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "CmsBlockImageThreeCover",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "cms-block-image-three-cover grid md:grid-cols-3 gap-10" }, _attrs))} data-v-337999ee>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../packages/cms-base/components/public/cms/block/CmsBlockImageThreeCover.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const CmsBlockImageThreeCover = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-337999ee"]]);

export { CmsBlockImageThreeCover as default };
//# sourceMappingURL=CmsBlockImageThreeCover-b3620ba2.mjs.map
